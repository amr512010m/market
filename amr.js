...
sb.onclick=function(){sb.onmouseout=function(){
      if(sv=='monitors'){ console.log( 'you searched about monitors');mobi.style.display='none'; lap.style.display='none';iphone.style.display='none';
                             acs.style.display='none'; moni.style.width='20%'}
	
                         else if(sv=='food'||sv=='FOOD'||sv=='Food '||sv==' Food '||sv==' Food   '||sv=='F ood '||sv=='Food'){mobi.style.display='block'; lap.style.display='none';iphone.style.display='none';
                             acs.style.display='none'; moni.style.display='none'}
	
                                else if(sv=='iphones'){console.log( 'you searched about iphones');mobi.style.display='none'; lap.style.display='none';iphone.style.display='block';
                             acs.style.display='none'; moni.style.display='none'}
	
                                                  else if(sv=='laptops'){console.log( 'you  searched about ');mobi.style.display='none'; lap.style.display='block';iphone.style.display='none';lap.style.width='20%';
                             acs.style.display='none'; moni.style.display='none'}
	
                            else if(sv=='mobile accessories'){console.log( 'you  searched about mobile accessories');mobi.style.display='none'; lap.style.display='none';iphone.style.display='none';lap.style.width='20%';
