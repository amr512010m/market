//vars collections
///////////////////////////////////////////////////////////////////////
var btnc11=document.getElementById('cbtn2');
var btnc12=document.getElementById('cbtn4');
  var btnc13=document.getElementById('cbtn3');
  var btnc14=document.getElementById('cbtn4');
var btnc15=document.getElementById('cbtn5');
var btnc16=document.getElementById('cbtn6');
var btnc17=document.getElementById('cbtn7');
var btnc18=document.getElementById('cbtn8');
var btnc19=document.getElementById('cbtn9');
var btnc20=document.getElementById('cbtn10');
var btnc21=document.getElementById('cbtn11');
  var btnc22=document.getElementById('cbtn12');
  var btnc23=document.getElementById('cbtn123');
//on click functions
////////////////////////////////////////////////////////////////////
btnc11.onclick=function(){alert('sorry! this product is un available press here &we will in form you when its available  ')}
btnc12.onclick=function(){alert('your order has beeen addded to cart')}
 btnc13.onclick=function(){alert('your order has beeen addded to cart')}
 btnc14.onclick=function(){alert('your order has beeen addded to cart')}
btnc15.onclick=function(){alert('your order has beeen addded to cart')}
btnc16.onclick=function(){alert('your order has beeen addded to cart')}
btnc18.onclick=function(){alert('your order has beeen addded to cart')}
btnc19.onclick=function(){alert('your order has beeen addded to cart')}
btnc20.onclick=function(){alert('your order has beeen addded to cart')}
  btnc22.onclick=function(){alert('your order has beeen addded to cart')}
  btnc23.onclick=function(){alert('your order has beeen addded to cart')}
btnc24.onclick=function(){alert('your order has beeen addded to cart')}
btnc25.onclick=function(){alert('your order has beeen addded to cart')}
///////////////////////////////////////////////////////////////////
var xxs0=document.getElementById('alert51')
var xxs1=document.getElementById('alert61')
var x51=document.getElementById('vbtn')
var x61=document.getElementById('alert61')
/////////////////////////////////////////////////////////////////
